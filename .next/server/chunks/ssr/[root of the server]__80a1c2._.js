...
"[project]/src/hooks/useAxios.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/hooks/useGenerateText.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_esm__({
    "default": (()=>useGenerateText)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAxios$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/useAxios.js [ssr] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAxios$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAxios$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
function useGenerateText() {
    const [description, setDescription] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null);
    ...
    const generate = async (query)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAxios$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["instance"].post("/api/llavaText/", {
                query: testPrompt
            });
            const data = res.data;
...
"[project]/src/hooks/useGenerateImage.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useGenerateImage() {
    ...
    const generate = async (query)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAxios$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["instance"].post("/api/sdxlImage/", {
                prompt
            });
...
"[project]/src/hooks/useDownloadImage.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = UseDownloadImage;
}}),
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__ = __turbopack_import__("[externals]/react/jsx-dev-runtime [external] (react/jsx-dev-runtime, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateText$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/useGenerateText.js [ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateImage$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/useGenerateImage.js [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDownloadImage$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/useDownloadImage.js [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__ = __turbopack_import__("[externals]/react [external] (react, cjs)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateText$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateImage$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateText$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hook$2d$form__$5b$external$5d$__$28$react$2d$hook$2d$form$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateImage$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
function Home() {
    ...
    const { generate: generateText, description, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateText$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"])();
    const { generate: generateImage, url, loading: loadingImage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGenerateImage$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"])();
    ...
    // UPLOAD FILE IMG
    const [imageSrc, setImageSrc] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('emploi.png');
    ...
    const { downloadImg } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDownloadImage$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"])(imageSrc);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("h1", {
                        className: "inp-label",
                        children: "Veuillez charger ici l'image"
                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                className: "vh-90 w-full bg-white flex flex-col items-center justify-center",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                    className: "image-download-tester",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("h1", {
                            className: "title",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
                            children: "Cliquez sur l'image pour la télécharger."
                        }, void 0, false, {
                            fileName: "[project]/src/pages/index.js",
                            lineNumber: 78,
                            columnNumber: 21
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__80a1c2._.js.map