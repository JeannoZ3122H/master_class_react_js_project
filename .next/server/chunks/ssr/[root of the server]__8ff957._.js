...
(()=>{
    const e = new Error("Cannot find module '@/hooks/useGenerateText'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
(()=>{
    const e = new Error("Cannot find module '@/hooks/useGenerateImage'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
function Home() {
    ...
    const { generate: generateImage, url, loading: loadingImage } = useGenerateImage();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8ff957._.js.map